...
public class PraticienModel {
    ...
    public PraticienModel(Connection connect, int index){
    ...
    public void result(){
        ...
        try (Statement state = connect.createStatement(); ResultSet result = state.executeQuery(query)){
            ...
            setNumero(resultArray.get(index).toString());
            setNom(resultArray.get(index+1).toString());
            setPrenom(resultArray.get(index+2).toString());
            setAdresse(resultArray.get(index+3).toString());
            setCP(resultArray.get(index+4).toString());
            setVille(resultArray.get(index+5).toString());
            setNotoriete(resultArray.get(index+6).toString());
            setExercice(resultArray.get(index+7).toString());
        }
        catch(Exception e){
            e.printStackTrace();
